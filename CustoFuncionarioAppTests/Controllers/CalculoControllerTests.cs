...
namespace CustoFuncionarioApp.Controllers.Tests
{
    ...
    public class CalculoControllerTests
    {
        ...
        [TestMethod]
        [DataRow(8250.50, 1200.00, 600.00, 800.00)]
        [DataRow(9000.00, 200.00, 100.00, 50.00)]
        [DataRow(50.00, 400.00, 180.00, 150.00)]
        [DataRow(6000.00, 1500.00, 900.00, 1100.00)]
        [DataRow(3500.00, 200.00, 150.00, 100.00)]
        [DataRow(4000.00, 600.00, 300.00d, 450.00d)]
        [DataRow(2000.00, 500.00, 300.00d, 150.00d)]
        [DataRow(4500.00, 800.00, 400.00d, 500.00d)]
        ...
        [TestMethod]
        [DataRow(3500.00, 600.00, 250.00, 350.00)]
        [DataRow(1800.00, 400.00, 200.00, 150.00)]
        [DataRow(4500.00, 800.00, 300.00, 450.00)]
